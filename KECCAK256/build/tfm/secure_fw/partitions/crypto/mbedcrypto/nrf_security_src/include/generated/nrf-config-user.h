 ...
 */
#define PSA_CRYPTO_DRIVER_CC3XX                            1

/* #undef PSA_CRYPTO_DRIVER_ALG_CBC_MAC_CC3XX */
#define PSA_CRYPTO_DRIVER_ALG_CBC_NO_PADDING_CC3XX         1
#define PSA_CRYPTO_DRIVER_ALG_CBC_PKCS7_CC3XX              1
#define PSA_CRYPTO_DRIVER_ALG_CCM_CC3XX                    1
#define PSA_CRYPTO_DRIVER_ALG_CMAC_CC3XX                   1
#define PSA_CRYPTO_DRIVER_ALG_CFB_CC3XX                    1
#define PSA_CRYPTO_DRIVER_ALG_CHACHA20_POLY1305_CC3XX      1
#define PSA_CRYPTO_DRIVER_ALG_CMAC_CC3XX                   1
#define PSA_CRYPTO_DRIVER_ALG_CTR_CC3XX                    1
#define PSA_CRYPTO_DRIVER_ALG_DETERMINISTIC_ECDSA_CC3XX    1
#define PSA_CRYPTO_DRIVER_ALG_ECB_NO_PADDING_CC3XX         1
#define PSA_CRYPTO_DRIVER_ALG_ECDH_CC3XX                   1
#define PSA_CRYPTO_DRIVER_ALG_ECDSA_CC3XX                  1
#define PSA_CRYPTO_DRIVER_ALG_GCM_CC3XX                    1
#define PSA_CRYPTO_DRIVER_ALG_HKDF_CC3XX                   1
#define PSA_CRYPTO_DRIVER_ALG_HMAC_CC3XX                   1
/* #undef PSA_CRYPTO_DRIVER_ALG_MD5_CC3XX */
/* #undef PSA_CRYPTO_DRIVER_ALG_PBKDF2_HMAC_CC3XX */
#define PSA_CRYPTO_DRIVER_ALG_RSA_OAEP_CC3XX               1
#define PSA_CRYPTO_DRIVER_ALG_RSA_PKCS1V15_CRYPT_CC3XX     1
#define PSA_CRYPTO_DRIVER_ALG_RSA_PKCS1V15_SIGN_CC3XX      1
#define PSA_CRYPTO_DRIVER_ALG_RSA_PSS_CC3XX                1
#define PSA_CRYPTO_DRIVER_ALG_SHA_1_CC3XX                  1
#define PSA_CRYPTO_DRIVER_ALG_SHA_224_CC3XX                1
#define PSA_CRYPTO_DRIVER_ALG_SHA_256_CC3XX                1
/* #undef PSA_CRYPTO_DRIVER_ALG_SHA_384_CC3XX */
#define PSA_CRYPTO_DRIVER_ALG_STREAM_CIPHER_CC3XX          1

#define PSA_CRYPTO_DRIVER_ECC_BRAINPOOL_P_R1_256_CC3XX     1
#define PSA_CRYPTO_DRIVER_ECC_MONTGOMERY_255_CC3XX         1
/* #undef PSA_CRYPTO_DRIVER_ECC_SECP_K1_192_CC3XX */
/* #undef PSA_CRYPTO_DRIVER_ECC_SECP_K1_224_CC3XX */
#define PSA_CRYPTO_DRIVER_ECC_SECP_K1_256_CC3XX            1
#define PSA_CRYPTO_DRIVER_ECC_SECP_R1_192_CC3XX            1
#define PSA_CRYPTO_DRIVER_ECC_SECP_R1_224_CC3XX            1
#define PSA_CRYPTO_DRIVER_ECC_SECP_R1_256_CC3XX            1
#define PSA_CRYPTO_DRIVER_ECC_SECP_R1_384_CC3XX            1
#define PSA_CRYPTO_DRIVER_ECC_SECP_R1_521_CC3XX            1
...
#define MBEDTLS_PLATFORM_SETUP_TEARDOWN_ALT                1
...
#define MBEDTLS_CMAC_ALT                                   1
#define MBEDTLS_CCM_ALT                                    1
/* #undef MBEDTLS_GCM_ALT */
#define MBEDTLS_CHACHA20_ALT                               1
#define MBEDTLS_POLY1305_ALT                               1
#define MBEDTLS_CHACHAPOLY_ALT                             1
#define MBEDTLS_DHM_ALT                                    1
