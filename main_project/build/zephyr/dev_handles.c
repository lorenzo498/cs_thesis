...
/* 5 : /soc/peripheral@40000000/uart@9000:
 * Direct Dependencies:
 *   - (/soc/interrupt-controller@e000e100)
 *   - (/soc/peripheral@40000000)
 * Supported:
 *   - /soc/peripheral@40000000/uart@9000/nrf-sw-lpuart
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_40000000_S_uart_9000[] = { DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, 7, DEVICE_HANDLE_ENDS };
...
/* 7 : /soc/peripheral@40000000/uart@9000/nrf-sw-lpuart:
 * Direct Dependencies:
 *   - /soc/peripheral@40000000/uart@9000
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_40000000_S_uart_9000_S_nrf_sw_lpuart[] = { 5, DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, DEVICE_HANDLE_ENDS };
