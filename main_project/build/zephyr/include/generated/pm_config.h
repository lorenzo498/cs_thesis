...
#define PM_NUM 3
#define PM_ALL_BY_SIZE "otp nrf_modem_lib_ctrl nrf_modem_lib_rx nrf_modem_lib_tx nrf_modem_lib_sram nvs_storage spm_sram sram_secure spm sram_primary sram_nonsecure app"
