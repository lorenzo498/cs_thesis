...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPS_SAMPLE_ANTENNA_ONBOARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPS_SAMPLE_AT_MAGPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPS_SAMPLE_AT_COEX0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_CMD_THREAD_STACK_SIZE, 1344);
